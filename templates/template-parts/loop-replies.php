...
<ul id="topic-<?php echo esc_attr( $topic_id ); ?>-replies"
	class="bs-item-list bs-forums-items bs-single-forum-list bb-single-reply-list list-view deaddove-custom-plugin-replies">
	...
	if ( bbp_thread_replies() ) :
        ...
        'callback' => 'dd_custom_bbp_reply_callback'
    ) );
	...
	elseif ( bbp_replies() ) :
		while ( bbp_replies() ) :
			...
			<li><?php dd_get_template_part( 'template-parts/loop', 'single-reply' ); ?></li>
