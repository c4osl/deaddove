...
$isBlurred = dd_is_topic_blurred( $topic_id );
$tagDescription = '';
if($isBlurred){
	$tagDescription = dd_blurTopic_description($topic_id);
}
 	  
?>

<ul id="topic-<?php echo esc_attr( bbp_get_topic_id() ); ?>-replies" class="bs-item-list bs-forums-items bs-single-forum-list bbp-lead-topic list-view  custom-plugin <?php echo esc_attr( $topic_reply_count < 1 ? 'topic-list-no-replies' : '' ); ?>">
	<li class="bs-item-wrap bs-header-item align-items-center no-hover-effect topic-lead">
		<div class="item flex-1">
			...
			<?php if ( 1 === $query_page || empty( $query_page ) ) { ?>
				...
				<div class="<?php echo esc_attr( $isBlurred ? 'item-description dd-forum-warning' : 'item-description' ); ?>" data-bbp-topic-id="<?php echo esc_attr( $topic_id ); ?>">
