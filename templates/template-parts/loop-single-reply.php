...
$isBlurred = dd_is_topic_blurred($reply_id);
 $tagDescription = '';
if($isBlurred){
	$tagDescription = dd_blurTopic_description($reply_id);
}
// print_r($tagDescription);
?>
...
<div id="post-<?php bbp_reply_id(); ?>" <?php bbp_reply_class( bbp_get_reply_id(), array(
    ...
    <div class ="<?php  echo esc_attr( $isBlurred ? 'bbp-reply-content bs-forum-content dd-forum-content dd-forum-warning': 'class="bbp-reply-content bs-forum-content dd-forum-content')?>" data-bbp-topic-id="<?php echo esc_attr( $reply_id );?>">

		<?php do_action( 'bbp_theme_before_reply_content' ); ?>

		<?php bbp_reply_content(); ?>
		<!-- <p class="blur-description" style="display:none;">Testststst</p>
		  -->
