...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content custom-plugin-template">
		<?php
		// the_content();
		// plugin_get_template_part('template-parts/content', 'single-topic-lead');
		dd_get_template_part('template-parts/content', 'single-topic');
